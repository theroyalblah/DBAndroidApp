...
public class EnrollAsMenteeStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeetingAdapter meetingEnrollAdapter = new MeetingAdapter(this, group_ids, meeting_names, dates, enrollment_size, times, meet_ids, "mentee", UserSession.getUser().getId());
